...
class _ManageServerPageState extends State<ManageServerPage> {
  ...
  final Color accentRed = const Color(0xFF5B4CFF);
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://tirz.panel.jserver.web.id:2001/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://tirz.panel.jserver.web.id:2001/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    final uri = Uri.parse('http://tirz.panel.jserver.web.id:2001/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          icon: const Icon(Icons.delete, color: Color(0xFF7A5CFF)),
