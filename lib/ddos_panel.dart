...
class _AttackPanelState extends State<AttackPanel>
  ...
  final String baseUrl = "http://tirz.panel.jserver.web.id:2001";
  ...
  final Color accentPurple = const Color(
    0xFF6B8CFF,
  ); // Warna aksen utama (Ungu)
  final Color cardDark = const Color(
    0xFF120A2B,
  ); // Warna kartu dengan tint ungu gelap
  ...
  Future<void> _sendDoos() async {
    ...
    if (selectedDoosId != "icmp" &&
        (port.isEmpty || int.tryParse(port) == null)) {
    ...
    try {
      ...
      if (data["cooldown"] == true) {
        ...
        _showAlert(
          "❌ Invalid Key",
          "Your session key is invalid. Please log in again.",
        );
      } else if (data["sended"] == false) {
        _showAlert(
          "⚠️ Failed",
          "Failed to send attack. The server may be under maintenance.",
        );
      } else {
        _showAlert(
          "✅ Success",
          "Attack has been successfully sent to $target.",
        );
      }
    } catch (_) {
  ...
  void _showAlert(String title, String msg) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text(
          title,
          style: TextStyle(color: primaryWhite, fontFamily: 'Orbitron'),
        ),
        content: Text(
          msg,
          style: TextStyle(
            ...
            children: [
              ...
              _buildInputCard(
                ...
                child: TextField(
                  ...
                  style: TextStyle(color: isIcmp ? const Color(0xFF6B66A6) : primaryWhite),
                  cursorColor: isIcmp ? const Color(0xFF6B66A6) : accentPurple,
              ...
              _buildInputCard(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    isExpanded: true,
                    iconEnabledColor:
                        accentPurple, // Ikon dropdown diubah ke ungu
                    style: TextStyle(color: primaryWhite),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        accentPurple, // Tombol utama diubah ke ungu
  ...
  InputDecoration _inputStyle(String hint, {bool isIcmp = false}) {
    return InputDecoration(
      hintText: hint,
      hintStyle: TextStyle(
        color: isIcmp ? const Color(0xFF6B66A6) : accentPurple,
      ), // Hint teks diubah ke ungu
      filled: true,
