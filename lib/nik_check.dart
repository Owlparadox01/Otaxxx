...
class _NikCheckerPageState extends State<NikCheckerPage>
  ...
  final Color accentPurple = const Color(
    0xFF6B8CFF,
  ); // Ungu Aksen (Lebih Terang)
  final Color lightPurple = const Color(0xFF4DA3FF); // Ungu Highlight
  final Color primaryWhite = Colors.white;
  final Color accentGrey = const Color(0xFFC7CEFF);
  final Color cardDark = const Color(
    0xFF120A2B,
  ); // Latar kartu dengan sedikit tint ungu
              ...
              if (_errorMessage != null)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color(
                      0xFF7A5CFF,
                    ).withOpacity(0.1), // Ubah ke ungu transparan
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                            ...
                            children: [
                              ...
                              _buildInteractiveInfoRow(
                                ...
                                value: _data!["data"]["tempat_lahir"]
                                    ?.toString(),
                                onCopy: () => _copyToClipboard(
                                  _data!["data"]["tempat_lahir"]?.toString() ??
                                      "",
                                  "Tempat Lahir",
                                ),
                              ),
                          ...
                          _buildCategoryCard(
                            ...
                            children: [
                              ...
                              _buildInteractiveInfoRow(
                                ...
                                value: _data!["data"]["ultah_mendatang"]
                                    ?.toString(),
                              ),
                              _buildInteractiveInfoRow(
                                label: "Pasaran",
